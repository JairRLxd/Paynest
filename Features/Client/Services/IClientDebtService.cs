...
public interface IClientDebtService
{
	...
	IReadOnlyList<Installment> GetCurrentGroupInstallments();
	Task<IReadOnlyList<Installment>> GetCurrentGroupInstallmentsAsync(CancellationToken cancellationToken = default);
	IReadOnlyList<Installment> GetPaidInstallmentsFromCurrentGroup();
	Task<IReadOnlyList<Installment>> GetPaidInstallmentsFromCurrentGroupAsync(CancellationToken cancellationToken = default);
